...
/**
 * Criteria class for the KhesaratSrneshin entity. This class is used in KhesaratSrneshinResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /khesarat-srneshins?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class KhesaratSrneshinCriteria implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        final KhesaratSrneshinCriteria that = (KhesaratSrneshinCriteria) o;
        return
    ...
    public String toString() {
        return "KhesaratSrneshinCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
