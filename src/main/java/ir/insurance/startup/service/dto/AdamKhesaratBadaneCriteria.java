...
/**
 * Criteria class for the AdamKhesaratBadane entity. This class is used in AdamKhesaratBadaneResource to
 * receive all the possible filtering options from the Http GET request parameters.
 * For example the following could be a valid requests:
 * <code> /adam-khesarat-badanes?id.greaterThan=5&amp;attr1.contains=something&amp;attr2.specified=false</code>
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
public class AdamKhesaratBadaneCriteria implements Serializable {

    private static final long serialVersionUID = 1L;

    private LongFilter id;

    private FloatFilter badane;
    ...
    public FloatFilter getBadane() {
        return badane;
    }

    public void setBadane(FloatFilter badane) {
        this.badane = badane;
    }
    ...
    public boolean equals(Object o) {
        ...
        final AdamKhesaratBadaneCriteria that = (AdamKhesaratBadaneCriteria) o;
        return
            Objects.equals(id, that.id) &&
            Objects.equals(badane, that.badane) &&
    ...
    public String toString() {
        return "AdamKhesaratBadaneCriteria{" +
                (id != null ? "id=" + id + ", " : "") +
                (badane != null ? "badane=" + badane + ", " : "") +
                (faal != null ? "faal=" + faal + ", " : "") +
