...
/**
 * A DTO for the MohasebeBadane entity.
 */
public class MohasebeBadaneDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        MohasebeBadaneDTO mohasebeBadaneDTO = (MohasebeBadaneDTO) o;
        if (mohasebeBadaneDTO.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), mohasebeBadaneDTO.getId());
    }
