package ir.insurance.startup.service.util;
...
public class CalendarUtil {
     ...
     */
    public CalendarUtil(GregorianCalendar gc){
        fromGregorian(gc);
    }
     ...
     */
    public CalendarUtil(LocalDate ld) {
     ...
     */
    public CalendarUtil getYesterday() {
     ...
     */
    public CalendarUtil getTomorrow() {
        return getDateByDiff(1);
    }
     ...
     */
    public CalendarUtil getDateByDiff(int diff) {
        GregorianCalendar gc = toGregorian();
        gc.add(Calendar.DAY_OF_MONTH, diff);
        return new CalendarUtil(gc);
    }
    ...
    public boolean equals(Object o) {
        ...
        CalendarUtil that = (CalendarUtil) o;
    ...
    private void fromJulianDay(int JulianDayNumber) {
        ...
        GregorianCalendar gregorianFirstFarvardin = new CalendarUtil(jalaliYear, 1, 1).getGregorianFirstFarvardin();
