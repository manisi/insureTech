...
public class EstelaamSalesNerkh implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        EstelaamSalesNerkh estelaamSalesNerkh = (EstelaamSalesNerkh) o;
        if (estelaamSalesNerkh.getId() == null || getId() == null) {
            return false;
        }
        return Objects.equals(getId(), estelaamSalesNerkh.getId());
    }
