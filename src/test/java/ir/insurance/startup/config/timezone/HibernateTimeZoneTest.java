package ir.insurance.startup.config.timezone;

import ir.insurance.startup.InsurancestartApp;
import ir.insurance.startup.repository.timezone.DateTimeWrapper;
import ir.insurance.startup.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM insutech_date_time_wrapper where id=%d", fieldName, id);
    }
