...
import { CityComponentsPage, CityDeleteDialog, CityUpdatePage } from './city-bimisho.page-object';
...
describe('City e2e test', () => {
    ...
    it('should load Cities', async () => {
        await navBarPage.goToEntity('city-bimisho');
    ...
    it('should load create City page', async () => {
        ...
        expect(await cityUpdatePage.getPageTitle()).to.eq('insurancestartApp.city.home.createOrEditLabel');
    ...
    it('should create and save Cities', async () => {
        ...
        await cityComponentsPage.clickOnCreateButton();
        await promise.all([cityUpdatePage.setNameInput('name'), cityUpdatePage.tipsSelectLastOption()]);
    ...
    it('should delete last City', async () => {
        ...
        expect(await cityDeleteDialog.getDialogTitle()).to.eq('insurancestartApp.city.delete.question');
