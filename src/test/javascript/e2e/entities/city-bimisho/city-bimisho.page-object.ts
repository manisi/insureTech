...
export class CityComponentsPage {
    ...
    deleteButtons = element.all(by.css('insutech-city-bimisho div table .btn-danger'));
    title = element.all(by.css('insutech-city-bimisho div h2#page-heading span')).first();
...
export class CityUpdatePage {
    pageTitle = element(by.id('insutech-city-bimisho-heading'));
