...
export class NerkhComponentsPage {
    ...
    deleteButtons = element.all(by.css('insutech-nerkh div table .btn-danger'));
    title = element.all(by.css('insutech-nerkh div h2#page-heading span')).first();
...
export class NerkhUpdatePage {
    pageTitle = element(by.id('insutech-nerkh-heading'));
