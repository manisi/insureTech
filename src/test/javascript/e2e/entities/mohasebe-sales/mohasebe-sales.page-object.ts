...
export class MohasebeSalesComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-mohasebe-sales div table .btn-danger'));
    title = element.all(by.css('jhi-mohasebe-sales div h2#page-heading span')).first();
...
export class MohasebeSalesUpdatePage {
    pageTitle = element(by.id('jhi-mohasebe-sales-heading'));
...
export class MohasebeSalesDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-mohasebeSales-heading'));
    private confirmButton = element(by.id('jhi-confirm-delete-mohasebeSales'));
