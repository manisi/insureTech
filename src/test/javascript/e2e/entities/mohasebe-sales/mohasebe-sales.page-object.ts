...
export class MohasebeSalesComponentsPage {
    createButton = element(by.id('jh-create-entity'));
    deleteButtons = element.all(by.css('insutech-mohasebe-sales div table .btn-danger'));
    title = element.all(by.css('insutech-mohasebe-sales div h2#page-heading span')).first();
...
export class MohasebeSalesUpdatePage {
    pageTitle = element(by.id('insutech-mohasebe-sales-heading'));
...
export class MohasebeSalesDeleteDialog {
    private dialogTitle = element(by.id('insutech-delete-mohasebeSales-heading'));
    private confirmButton = element(by.id('insutech-confirm-delete-mohasebeSales'));
