...
export class KhodroComponentsPage {
    ...
    deleteButtons = element.all(by.css('insutech-khodro div table .btn-danger'));
    title = element.all(by.css('insutech-khodro div h2#page-heading span')).first();
...
export class KhodroUpdatePage {
    pageTitle = element(by.id('insutech-khodro-heading'));
