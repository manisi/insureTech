...
export class NerkhComponentsPage {
    ...
    deleteButtons = element.all(by.css('insutech-nerkh-bimisho div table .btn-danger'));
    title = element.all(by.css('insutech-nerkh-bimisho div h2#page-heading span')).first();
...
export class NerkhUpdatePage {
    pageTitle = element(by.id('insutech-nerkh-bimisho-heading'));
...
export class NerkhDeleteDialog {
    private dialogTitle = element(by.id('insutech-delete-nerkh-heading'));
    private confirmButton = element(by.id('insutech-confirm-delete-nerkh'));
