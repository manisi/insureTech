...
import { SherkatBimeComponentsPage, SherkatBimeDeleteDialog, SherkatBimeUpdatePage } from './sherkat-bime-bimisho.page-object';
...
describe('SherkatBime e2e test', () => {
    ...
    it('should load SherkatBimes', async () => {
        await navBarPage.goToEntity('sherkat-bime-bimisho');
