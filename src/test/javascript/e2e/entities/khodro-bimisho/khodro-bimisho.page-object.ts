...
export class KhodroComponentsPage {
    ...
    deleteButtons = element.all(by.css('insutech-khodro-bimisho div table .btn-danger'));
    title = element.all(by.css('insutech-khodro-bimisho div h2#page-heading span')).first();
...
export class KhodroUpdatePage {
    pageTitle = element(by.id('insutech-khodro-bimisho-heading'));
...
export class KhodroDeleteDialog {
    private dialogTitle = element(by.id('insutech-delete-khodro-heading'));
    private confirmButton = element(by.id('insutech-confirm-delete-khodro'));
