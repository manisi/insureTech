...
import { TipKhodroComponentsPage, TipKhodroDeleteDialog, TipKhodroUpdatePage } from './tip-khodro-bimisho.page-object';
...
describe('TipKhodro e2e test', () => {
    ...
    it('should load TipKhodros', async () => {
        await navBarPage.goToEntity('tip-khodro-bimisho');
