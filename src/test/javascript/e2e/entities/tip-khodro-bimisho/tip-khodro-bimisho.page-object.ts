...
export class TipKhodroComponentsPage {
    ...
    deleteButtons = element.all(by.css('insutech-tip-khodro-bimisho div table .btn-danger'));
    title = element.all(by.css('insutech-tip-khodro-bimisho div h2#page-heading span')).first();
...
export class TipKhodroUpdatePage {
    pageTitle = element(by.id('insutech-tip-khodro-bimisho-heading'));
