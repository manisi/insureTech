...
export class PoosheshComponentsPage {
    ...
    deleteButtons = element.all(by.css('insutech-pooshesh-bimisho div table .btn-danger'));
    title = element.all(by.css('insutech-pooshesh-bimisho div h2#page-heading span')).first();
...
export class PoosheshUpdatePage {
    pageTitle = element(by.id('insutech-pooshesh-bimisho-heading'));
