...
import { CountryComponentsPage, CountryDeleteDialog, CountryUpdatePage } from './country-bimisho.page-object';
...
describe('Country e2e test', () => {
    ...
    it('should load Countries', async () => {
        await navBarPage.goToEntity('country-bimisho');
    ...
    it('should load create Country page', async () => {
        ...
        expect(await countryUpdatePage.getPageTitle()).to.eq('insurancestartApp.country.home.createOrEditLabel');
    ...
    it('should create and save Countries', async () => {
        ...
        await countryComponentsPage.clickOnCreateButton();
        await promise.all([countryUpdatePage.setNameInput('name')]);
    ...
    it('should delete last Country', async () => {
        ...
        expect(await countryDeleteDialog.getDialogTitle()).to.eq('insurancestartApp.country.delete.question');
