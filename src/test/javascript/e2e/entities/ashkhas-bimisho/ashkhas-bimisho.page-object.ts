...
export class AshkhasComponentsPage {
    ...
    deleteButtons = element.all(by.css('insutech-ashkhas-bimisho div table .btn-danger'));
    title = element.all(by.css('insutech-ashkhas-bimisho div h2#page-heading span')).first();
...
export class AshkhasUpdatePage {
    pageTitle = element(by.id('insutech-ashkhas-bimisho-heading'));
