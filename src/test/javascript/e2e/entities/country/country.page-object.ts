...
export class CountryComponentsPage {
    ...
    deleteButtons = element.all(by.css('insutech-country div table .btn-danger'));
    title = element.all(by.css('insutech-country div h2#page-heading span')).first();
...
export class CountryUpdatePage {
    pageTitle = element(by.id('insutech-country-heading'));
