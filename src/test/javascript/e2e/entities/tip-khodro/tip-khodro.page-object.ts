...
export class TipKhodroComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-tip-khodro div table .btn-danger'));
    title = element.all(by.css('jhi-tip-khodro div h2#page-heading span')).first();
...
export class TipKhodroUpdatePage {
    pageTitle = element(by.id('jhi-tip-khodro-heading'));
...
export class TipKhodroDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-tipKhodro-heading'));
    private confirmButton = element(by.id('jhi-confirm-delete-tipKhodro'));
