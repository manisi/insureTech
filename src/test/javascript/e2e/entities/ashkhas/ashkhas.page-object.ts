...
export class AshkhasComponentsPage {
    ...
    deleteButtons = element.all(by.css('jhi-ashkhas div table .btn-danger'));
    title = element.all(by.css('jhi-ashkhas div h2#page-heading span')).first();
...
export class AshkhasUpdatePage {
    pageTitle = element(by.id('jhi-ashkhas-heading'));
...
export class AshkhasDeleteDialog {
    private dialogTitle = element(by.id('jhi-delete-ashkhas-heading'));
    private confirmButton = element(by.id('jhi-confirm-delete-ashkhas'));
