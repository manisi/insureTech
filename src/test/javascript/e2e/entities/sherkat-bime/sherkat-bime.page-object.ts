...
export class SherkatBimeComponentsPage {
    ...
    deleteButtons = element.all(by.css('insutech-sherkat-bime div table .btn-danger'));
    title = element.all(by.css('insutech-sherkat-bime div h2#page-heading span')).first();
...
export class SherkatBimeUpdatePage {
    pageTitle = element(by.id('insutech-sherkat-bime-heading'));
